...
Well, there is a list on the Facebook page — see above for the details. But you're just supposed to know. Maybe try tuning into a numbers channel that might have the most up-to-date information.
...
**Medic:** When someone is hurt, first call a Hold, then call for a Medic. If you have any medical issues, be sure to inform the Medics for the event: John Thompson and Kat Burns.
...
**White Headband (Out of Game):** You are In Game unless you are wearing a white headband. NPCs can go Out of Game by placing a hand or weapon on top of their head to go out of game quickly, but they will be using white headbands if they are Out of Game for an extended period of time.

**Orange Headband (Page Status):** Some players at the event cannot enter combat and are playing as a Page. A player playing as a Page should never be struck with a buffer weapon or a packet. In order to attack a Page, point a weapon or packet at the Page and state either “**I kill you, Page!**” (Death) or “**I down you, Page**” (Bleeding Out). A player within 5 feet of the Page may choose to defend the Page and block the attack. To do so, the player must state “**I defend you**” and role-play accordingly. A person cannot defend a Page if they do not have a weapon, shield, or other ability to do so. Encounters that are non-combat will have an orange sash on the module hook, and any Adventure Cards that are non-combat will be clearly marked.
...
**Non-Standard Effects:** If there are Non-Standard Effects on a module or encounter, the Running Staff will ask you if you accept them. If you do not accept the effects, you will have the opportunity to leave the encounter, or in some situations another effect may be substituted.
...
**Game End**: Game will end at 3:00 AM. Adventure Cards and Town Encounters may still be run if there are NPCs awake. Plot starts at 9:00 AM.
