...
- Facebook is terrible for discoverability.
  ...
  - Facebook makes it hard to know who is interested versus who is just browsing.
...
This is optional; it's really just for yamllint, which you can also use at yamllint.com. I do not think you really need it unless you are doing a lot of YAML.
...
- I have sometimes seen Hugo use TOML. It is fine, but I would prefer everything to be in YAML.
...
- You are not just writing Markdown. There is metadata that goes with your documents.
- <https://gohugo.io/content-management/front-matter/>

### Docsy Hugo Theme

- It is not a small part; it is half of the puzzle.
- It is not easily switched out, despite what the documentation may lead you to believe.
- <https://www.docsy.dev/>
- Docsy Example Site
...
- We will go as slowly as the slowest person on the call.
- If you have any questions, ask, and we will talk them through. There is no need to stay confused.
  - If you want to go over this again, please let me know. We can go through any parts you have had trouble with.
...
- Push the changes.
- Confirm that everything is working and watch the site build.

## Configure Search in Hugo Setup File

- Add the search configuration to the Hugo setup file.
- Confirm that search works correctly in the local preview.

## Configure GitHub in Hugo Setup File

- Add the GitHub repository and site configuration settings.
- Confirm that the connection and metadata are correct.
