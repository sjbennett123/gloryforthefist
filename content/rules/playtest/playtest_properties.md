...
Welcome to NERO LARP’s Personal Estate System. This system is designed to work in tandem with the larger NERO LARP Estate System, which covers running estates ranging from small hamlets to entire empires. The Personal Estate System is designed to allow players to further develop their characters by purchasing homes and/or businesses, as well as hiring employees and hirelings. While the bulk of this system exists to give your character “a place to live” and “some place to be while not adventuring,” certain aspects allow players to maintain and improve their holdings.

The first rule of the Personal Estate System is that everything exists with the permission of your local chapter’s plot committee. That means that if your plot committee does not want you to build an inn or tavern in the Swamp of Dreaded Death, you will not be allowed to construct such a building in that location. Additionally, in many situations, one would need to get permission from the local nobles before building a home or business. It would not be feasible for a character who belongs to Faction A to build a fortified manor in the territory of their enemy, Faction B. The nobles of Faction B would not allow such a thing to happen. As such, under most circumstances, permission must be sought (in-game) from the local nobles and your local plot committee.

The second rule of the Personal Estate System is that everything can be affected, either for good or ill, by your local plot committee. If your local plot committee decides that the town in which your business is located suddenly falls into the sea, your business will be lost as well. On the other hand, if the town in which your home is located is affected by beneficial magic, your home will share in that benefit. Your local plot will have as much of an effect on your estates as it can have on your character.

The third rule of the Personal Estate System is that everything is in flux, and everything is interconnected. That means that during one period, you can experience a windfall, and during other periods, you can experience tragedy. Your personal estates can be affected by weather, crime, magic, random events, and events that affect the town, city, barony, county, duchy, kingdom, or empire in which your estate resides.

The final rule of the Personal Estate System is to use the system primarily as a means to further define your character and to have fun. The system is designed to be balanced. There will be equal opportunities for gain and loss. The outcomes that occur during each week or month can be determined by your local plot committee or happen at random. In either case, you are encouraged to use the events in your character’s story.
...
All purchases and income transacted in the Estate System use the character’s Estate Bank, which is a separate account from the character’s regular bank. The reason for this is that the estate system can generate some very large numbers, which would throw the in-game economies of most chapters completely out of balance. Since the estate system is mainly an off-board system, a different metric of currency is needed that will 1) allow players to gain wealth within the system to improve their estates, and 2) keep that wealth from filtering back into the in-game economies of NERO chapters. The estate system is an off-board “mini-game” that has indirect ties to the in-game realm.

A character can deposit money from their character’s bank into their Estate Bank at a ratio of 1 to 2. For every 1 silver taken from the character’s bank, 2 silvers are put into the Estate Bank. For example, when transferring 250 silver from the character’s bank, a total of 500 silver would be placed into the Estate Bank.
...
Every property, except campsites, requires monthly upkeep, which represents paying for repairs to your building, water, firewood, and so on. This amount is automatically deducted from your Estate Bank each month.

Businesses generate revenue through the sale of products or services. Each business has a base amount of revenue it will generate in a week or month. This base revenue represents the part-time work your character does at the store instead of being off adventuring.
...
Each property is made up of rooms. Each room type serves a distinct purpose, ranging from sleeping quarters to sales floors. The property comes with a default set of rooms. These are the rooms most likely found in the type of property purchased.
...
Estate Assets are objects that are added to rooms or properties and grant a special ability to the property.

Workshop assets, when placed in the appropriate room type, grant the character the bonuses of a Crafting Workshop (see NERO LARP Rulebook, pp. 32–33). The workshop is designated for a specific crafting skill (i.e., Alchemy, Smithing, Potion Making, Scroll Making, or Trap Making). The workshop will always be accessible to the owner as long as the owner is at the property. If a character cannot travel to the property where the workshop is located, they will be unable to use the workshop’s bonuses when producing items for an event. Workshops are local-chapter-only, so they can only be used for events that take place in the chapter where the property exists.

Non-personal workshops (i.e., Group, Guild, and Town workshops) allow the owner to grant other characters trustee privileges. When an owner makes another character a trustee, that character will be able to use the workshop to produce items for events. As with the owner, trustees must be able to visit the property in order to use the workshop. A trustee cannot use a workshop for an event outside of the chapter in which the property and workshop are located.

For a list of estate assets, see Table 1-4 (Estate Asset Types).

## **Character Employees & Hirelings**

Employees and hirelings are NPC characters created by the system to work for the character in various capacities. Employees are NPCs that work as general help, such as a clerk in the character’s shop or a barkeep who works in the character’s tavern.
...
| Great Hall                 | 12                   | An open hall used for concerts, stage performances, and dances, with room for up to 50 people |
| Great Hall (Large)         | 20                   | An open hall used for concerts, stage performances, and dances, with room for up to 100 people |
