...
title: "NERO 9th Edition Changelog"
...
**Banish** - Now applies to both schools.

**Circle of Power** - 10 minutes; no longer required for a platform circle.

**Create Undead** - Lasts 5 minutes and now suspends the death count. It also restores you to full body, is not a visible effect, and you fight at full speed.
...
**Weakness** - Swing 5 less (was 4 less).
...
**Weapon Proficiency** - Removed the scaling build structure, and proficiencies now cost 15/20/30/18.

**Critical Slay/Parry** - Slays now do a flat 100 points of damage. Build cost changed to 10/15/20/13.

**Master Proficiency** - Removed the scaling build structure, and master proficiencies now cost 17/24/34/22.
...
**Waylay** - Is now a daily skill, lasts 5 minutes, and has the same requirements as assassinate (standing behind, seeing both shoulder blades). Requires a short weapon (or small weapon). Can be parried, dodged, or resisted as a physical attack. Build cost is 6/3/6/6, and you may only purchase additional uses once for every 5 levels your character attains.

**Herbal Lore** - Now detects and identifies a substance in food or drink in 3 seconds, and can be used to destroy that substance in 1 minute of roleplay (so that the food or drink is safe).

**Smithing** - Changed the number of levels required for silvering a weapon, removed flawless refit, and now costs 3/4/4/4.
...
**Weapons** - No longer require an open cell on the pommel of the weapon. Ultralights have been added to the weapon construction information.
...
**Targeted Effects** - Targeted effects have changed significantly from the way they worked in 8th edition. If you are hit with a targeted effect (such as Wither, Shatter, or Destroy), you cannot assign it to an item or location that would take no effect from the attack. For example, if someone hit you with a "Magic Wither Arm" and your left arm was already withered, you'd have to take the effect on your right arm. If you were hit with a "Magic Destroy Weapon" effect, you would have to take it on a non-rendered item. If there is no legal target (or the only legal targets are withered/rendered), do not call "No Effect." If delivered by a carrier attack, you will still take the damage associated with the attack.
...
**Obliterate** - Cannot be contested for 1 hour (wording is strange; is this true?).
...
· **Laughing Poison** - Removed from the game.

· **Love and Love 9** - Removed from the game.

· **Forget-Me-Not, Forget-It-Well** - No longer uses a phrase, as the target simply forgets the set amount of time. Can receive Purify Blood in 10 minutes to remember. If you dissipate before the 10 minutes are up, the Forget effect fails and the character remembers everything.
...
· **Vorpal Coatings** - All vorpal coatings add 5 to the damage of a weapon swing. They are not used until they connect or are negated with a defense. Vorpal 1 lasts for 1 strike, Vorpal 3 lasts for 3 strikes, and Vorpal 5 lasts for 5 strikes.
...
· **Small weapons** - 1 production level.

· **One-handed weapons, shields, and arrows** - 2 production levels.

· **Staff** - 3 production levels.

· **Two-handed weapons** - 4 production levels.
